 ...
 */
operatorShell.service('settings', function (localStorageService) {
    ...
    var
        ...
        DEFAULT_CLIENT_ID = "arm1",

        wampServerLocalStorageKey = "operatorShellWampServerUrl",
        clientIdLocalStorageKey = "operatorShellClientId",
